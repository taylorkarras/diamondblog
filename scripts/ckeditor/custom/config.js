...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'divarea,wysiwygarea,notification,blockquote,panelbutton,find,removeformat,selectall,a11yhelp,widget,notificationaggregator,lineutils';
