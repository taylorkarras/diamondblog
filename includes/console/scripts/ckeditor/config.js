...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'wysiwygarea,autosave,notification,blockquote,colorbutton,panelbutton,find,removeformat,selectall,a11yhelp,image,uploadimage,widget,uploadwidget,filetools,notificationaggregator,lineutils,embed,embedbase,justify';
